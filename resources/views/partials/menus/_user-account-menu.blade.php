...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
	...
	<div class="menu-item px-3">
		<div class="menu-content d-flex align-items-center px-3">
			...
			<div class="symbol symbol-50px me-5">
				<img alt="Logo" src="{{ auth()->user()->avatarUrl ?? asset(theme()->getMediaUrlPath() . 'avatars/blank.png') }}" />
			</div>
			<!--end::Avatar-->
			<!--begin::Username-->
	...
	<!--begin::Menu item-->
	<div class="menu-item px-5">
        <a href="{{ route('admin.logout') }}" data-action="{{ route('admin.logout') }}" data-method="post" data-csrf="{{ csrf_token() }}" data-reload="true" class="button-ajax menu-link px-5">{{ __('Sign Out') }}</a>
    </div>
	<!--end::Menu item-->
</div>
