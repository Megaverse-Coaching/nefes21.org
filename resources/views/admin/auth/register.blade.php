<x-auth-layout>
    ...
    <!--begin::Signup Form-->
    <form class="form w-100 " novalidate="novalidate" id="kt_sign_up_form" action="{{ theme()->getPageUrl('admin.register.store') }}">
    @csrf
    <!--begin::Heading-->
        ...
        <div class="text-gray-500 text-center fw-semibold fs-6">Already have an Account?
            <a href="{{ theme()->getPageUrl('admin.login') }}" class="link-primary fw-semibold">Sign in</a></div>
        <!--end::Sign up-->
        <div></div>
    </form>
    <!--end::Signup Form-->
