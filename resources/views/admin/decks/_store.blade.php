...
@endif
<form method="POST" id="deckForm" action="{{ route('admin.decks.store') }}" enctype="multipart/form-data">
    @csrf @method('POST')
    <div class="d-flex flex-row h-600px">
        <div class="d-flex flex-column flex-row-auto w-300px me-20">
            <div class="d-flex flex-column flex-start">
                ...
                <div class="col-md-12 fv-row">
                    <!--begin::Image input-->
                    <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url({{ asset('storage/placeholder-showcase.jpg') }}); background-repeat: no-repeat; background-size: cover; background-position: center;">
                        <!--begin::Image preview wrapper-->
                        <div class="image-input-wrapper h-150px w-300px bgi-position-center" style="background-image: url({{ asset('storage/placeholder-showcase.jpg') }});background-repeat: no-repeat;background-size: cover;background-position: center;"></div>
