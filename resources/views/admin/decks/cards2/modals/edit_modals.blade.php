...
<div class="modal fade" id="kt_modal_edit_card" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content card">
            ...
            <!--begin::Form-->
            <form class="form" action="{{ route('admin.cards.edit', $card->id) }}" id="cardUpdateForm">
                @csrf @method('POST')
                <input type="hidden" name="deck_id" value="{{ request()->deck }}">
                <!--begin::Modal header-->
                <div class="modal-header" id="kt_modal_edit_card_header">
                    <!--begin::Modal title-->
                    <h2>Add New Card</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <div class="modal-body py-10 px-lg-17">
                    <!--begin::Scroll-->
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_edit_card_scroll" data-kt-scroll="true"
                         data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto"
                         data-kt-scroll-dependencies="#kt_modal_edit_card_header"
                         data-kt-scroll-wrappers="#kt_modal_edit_card_scroll" data-kt-scroll-offset="300px">
...
{{--                                    data-dropdown-parent="#kt_modal_edit_card"--}}
                ...
                <div class="modal-footer flex-center">
                    ...
                    <button type="reset" id="kt_modal_edit_card_cancel" class="btn btn-light me-3">Discard</button>
                    <!--end::Button-->
                    <!--begin::Button-->
                    <button type="submit" class="btn btn-sm btn-bg-info text-white" form="kt_modal_edit_card_modal" id="kt_modal_edit_card_submit">
