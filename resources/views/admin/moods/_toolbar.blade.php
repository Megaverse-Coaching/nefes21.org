<div class="card-toolbar">
    ...
    <div class="d-flex justify-content-end" data-kt-table-toolbar="base">
        ...
        <button type="button" class="btn btn-light-primary me-3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
            ...
            <!--begin::Menu 1-->
            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="menuSub">
                <!--begin::Header-->
                <div class="px-7 py-5">
                ...
                <div class="px-7 py-5" data-kt-table-filter="form">
                    <!--begin::Input group-->
                    <div class="mb-10">
                        <label class="form-label fs-6 fw-semibold">Mood:</label>
                        <select name="mood_id" id="moodSelect" tabindex="-1" class="form-select form-select-solid form-select-lg" data-dropdown-parent="#menuSub" data-control="select2" data-placeholder="Select Mood" data-allow-clear="true">
    ...
    <div class="d-flex justify-content-end align-items-center d-none"
        ...
        <div class="fw-bold me-5">
            <span class="me-2" data-kt-table-select="selected_count"></span> tane Seçildi
        </div>
