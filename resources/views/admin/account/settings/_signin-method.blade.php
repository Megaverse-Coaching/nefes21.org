        ...
        <div class="card-body border-top p-9">
            ...
            <div class="d-flex flex-wrap align-items-center">
                ...
                <div id="kt_signin_email_edit" class="flex-row-fluid d-none">
                    <!--begin::Form-->
                    <form id="kt_signin_change_email" class="form" novalidate="novalidate" method="POST" action="{{ route('admin.settings.changeEmail') }}">
                        @csrf
                        @method('PUT')
            ...
            <div class="d-flex flex-wrap align-items-center mb-10">
                ...
                <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                    <!--begin::Form-->
                    <form id="kt_signin_change_password" class="form" novalidate="novalidate" method="POST" action="{{ route('admin.settings.changePassword') }}">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="current_email" value="{{ auth()->user()->email }} "/>
                        <div class="row mb-1">
