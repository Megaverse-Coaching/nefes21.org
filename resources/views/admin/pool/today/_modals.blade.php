                ...
                <form id="kt_modal_add_form" class="form" action="{{ route('admin.moods.store') }}">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select name="mood_id" class="form-select form-select-solid form-select-lg" data-dropdown-parent="#kt_modal_add" data-control="select2" data-placeholder="Select a Mood" data-allow-clear="true" >
                ...
                <form id="kt_modal_update_form" class="form">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select name="mood_id" class="form-select form-select-solid form-select-lg" data-dropdown-parent="#kt_modal_update" data-control="select2" data-placeholder="Select a Mood" data-allow-clear="true" >
                                <option value="">Select Mood...</option>
{{--                                @foreach ($moods as $item)--}}
{{--                                    <option value="{{ $item->mood_id }}">{{ $item->title }}</option>--}}
{{--                                @endforeach--}}
