    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_add_header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Add Content to {{$title->title}}</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="kt_modal_add_form" class="form" action="{{ route('admin.dimensions.store') }}">
                    <input type="hidden" name="dimension_id" value="{{ $title->dimension }}">
                    @csrf @method('POST')
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y me-n7 pe-7"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select name="category_id" class="form-select form-select-solid form-select-lg" data-dropdown-parent="#kt_modal_add" data-control="select2" data-placeholder="Select a Category" data-allow-clear="true" >
                                <option value="">Select Category...</option>
                                @foreach($categoryTitles as $id => $title)
                ...
                <form id="kt_modal_update_form" class="form">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select name="dimension_id" class="form-select form-select-solid form-select-lg" data-dropdown-parent="#kt_modal_update" data-control="select2" data-placeholder="Select a Dimension" data-allow-clear="true" >
