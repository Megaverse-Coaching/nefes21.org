<x-base-layout>
    @section('styles')
        <style> #kt_table_categories_filter{ display: none; visibility: hidden} </style>
    @endsection
    <!--begin::Toolbar-->
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <!--begin::Toolbar container-->
        @include('admin.categories._toolbar')
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <!--begin::Card title-->
                    <!--begin::Card toolbar-->
                    @include('admin.categories._card-toolbar')
                    <!--end::Card toolbar-->
                </div>
                <!--end::Card header-->
                <!--begin::Card body-->
    ...
    @section('scripts')  <script> $(document).ready(() => $("#kt_table_categories_filter").addClass('d-none')); </script>  @endsection
</x-base-layout>
