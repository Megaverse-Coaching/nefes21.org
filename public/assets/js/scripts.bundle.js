...
var Base = function () {
    var e = "active",
        ...
        i = function () {
            var a, i, n, l, r;
            if ($('[data-scroll="true"]').each((function () {
            ...
            })), document.querySelector(".dropzone") && (Dropzone.autoDiscover = !1, new Dropzone(".dropzone", {
                url: "/file/post"
            })), a = "mat-tabs__line", i = $("<span>", {
                class: a
            }), n = $(".mat-tabs"), l = $(".nav-link"), n.each((function () {
                ...
                var e = $(this);
                e.closest(".mat-tabs").find("." + a).stop().css({
                    left: e.position().left,
                    width: e.outerWidth()
                })
            })), r = !1, $(".sidebar-toggler").on("click", (function () {
    ...
    return {
        init: function () {
            $("#loader").fadeOut(1e3), t.settings(), i();
            $(document).on("click", 'a:not([href^="#"])a:not([href^="mail"])a:not([href^="tel"]):not([href^="javascript"]):not(.external):not([target])', function (n) {
                ...
                if (r) {
                    var s = $("#line_loader");
                    window.history.pushState("", "", r), s.show().animate({
                    ...
                    $.ajax({
                        ...
                        if ("success" === t && 200 == n.status) {
                            ...
                            i(), a(), Dashboard.init();
                            initFlipsterAndCards();
                            initFontIncrease();
                        }
                    }).fail(function () {
                        window.location.href = "404.html";
                    }).always(function () {
                        l.length && $(window).width() < 992 && ($(".sidebar-toggler").toggleClass(e), t.removeAttr("data-sidebar-toggle")), s.animate({
                            width: "100%"
...
var ChartJs = {
    overrideDefaults() {
        ...
        Object.assign(e, t), Object.assign(e.plugins.tooltip, {
            titleMarginBottom: 6,
            caretSize: 6,
            caretPadding: 10,
            boxWidth: 10,
                    ...
                    var a = {
                        ...
                        data: {
                            ...
                            datasets: [{
                                ...
                                pointHoverBorderColor: Chart.helpers.color(Utils.getCSSVarValue("red")).alpha(.1).rgbString()
                            }]
                        },
                        options: {
                            title: {
...
function initFlipsterAndCards() {
    // Eğer “coverflow” ID'li eleman hep varsa, direk Flipster’ı başlat:
    $("#coverflow").flipster();

    // Kartların tıklanınca dönmesi
    $("li#firstcard.flipster__item.flipster__item--current").mouseenter().click();

    const deckcards = document.querySelectorAll('.card-flipster');
...
function initFontIncrease(){
    ...
    $(document).ready(function () {
        // $("#start_trial_btn").on('click', () => $("#start_trial_modal").modal('show'));
        getSize();
...
var Player = function () {
    var e = "active",
        ...
        i = [],
        n = function (t = !0) {
            $("#player").addClass("show"), Amplitude.getSongs() && 1 === Amplitude.getSongs().length && (Amplitude.pause(), setTimeout((() => {
            ...
            var n = i[0];
            s(!1), a.html(o(n)), $(".amplitude-play-pause").removeClass("amplitude-paused").addClass("amplitude-playing"), t && Amplitude.play(), r(n)
        },
        l = function (e) {
        ...
        o = function (e) {
            var t = Amplitude.getActiveSongMetadata();
            return `<div class="list__item"\n        data-song-id="${e.id}"\n        data-song-name="${e.name}"\n        data-song-artist="${e.artist}"\n        data-song-album="${e.album}"\n        data-song-url="${e.url}"\n        data-song-cover="${e.cover_art_url}">\n            <div class="list__cover">\n                <img src="${e.cover_art_url}" alt="${e.name}">\n                <a href="javascript:void(0);" class="btn btn-play btn-sm btn-default btn-icon rounded-pill ${e.id === t.id ? "active" : ""}" data-play-id="${e.id}">\n                    <i class="ri-play-fill icon-play"></i>\n                    <i class="ri-pause-fill icon-pause"></i>\n                </a>\n            </div>\n            <div class="list__content">\n                <a href="song-details.html" class="list__title text-truncate">${e.name}</a>\n                <p class="list__subtitle text-truncate">\n                    <a href="artist-details.html">${e.artist}</a>\n                </p>\n            </div>\n            <ul class="list__option">\n                <li class="list__icon-hover">\n                    <a href="javascript:void(0);" role="button" class="d-inline-flex" data-remove-song-id="${e.id}">\n                        <i class="ri-close-line fs-6"></i>\n                    </a>\n                </li>\n                <li>\n                    <a href="javascript:void(0);" role="button" class="d-inline-flex" data-favorite-id="${e.id}">\n                        <i class="ri-heart-line heart-empty"></i>\n                        <i class="ri-heart-fill heart-fill"></i>\n                    </a>\n                </li>\n            </ul>\n        </div>`
        },
        d = function () {
            i = [], s(), Amplitude.pause(), Utils.removeLocalItem("songs"), a.html('<div class="col-sm-8 col-10 mx-auto mt-5 text-center">\n            <i class="ri-music-2-line mb-3"></i>\n            <p>No songs, album or playlist are added on lineup.</p>\n        </div>')
        };
    return {
        ...
        init: function () {
            ...
            var albumSarkilariniBul = function () {
                return $("[data-song-album]").map(function () {
                    return l(this); // l fonksiyonunu kullanarak elementin detaylarını al
                }).get();
            };
            ...
            !function () {
                ...
                t.on("click", "[data-play-id]", function () {
                    ...
                    var albumSarkilari = albumSarkilariniBul();

                    // Şarkının albüm şarkıları içinde olup olmadığını kontrol edelim
                    var r = albumSarkilari.findIndex(e => e.id === t.id);

                    // Eğer tıklanan şarkı zaten çalınıyorsa
                    if ($(this).hasClass(e)) {
                        $("[data-play-id]").removeClass(e);
                        Amplitude.pause();
                        $(".amplitude-play-pause").removeClass("amplitude-playing").addClass("amplitude-paused");
                    } else {
                        i = albumSarkilari; // Direkt albüm şarkıları listesini atayalım.
                        n(false); // Oynatıcıyı başlat
                        Amplitude.playSongAtIndex(r); // Tıklanan şarkının indeksine göre şarkıyı başlat
                ...
                t.on("click", "[data-next-id]", (function () {
                    ...
                    i && !i.length ? (i.push(t), n(), $("[data-play-id=" + t.id + "]").addClass(e)) : -1 === s ? (i.splice(r + 1, 0, t), a.find(".list__item").eq(r).after(o(t))) : Utils.showMessage("Song already in Queue"), Utils.setLocalItem("songs", i)
                })),
                ...
                (r = $(".player-volume")).find('input[type="range"]').on("input", (function () {
                    var e = r.find(".ri-volume-mute-fill"),
                        ...
                        l = "d-block",
                        s = "d-none";
                    Player.volumeBackground(), 0 === n ? (e.removeClass(s).addClass(l), t.addClass(s), a.addClass(s)) : n > 0 && n < 70 ? (e.addClass(s), t.removeClass(s).addClass(l), a.addClass(s)) : n > 70 && (e.addClass(s), t.addClass(s), a.removeClass(s).addClass(l))
...
$(document).ready((function () {
    ...
    function (e, t, a, i) {
        e.fn.extend({
            settings: function (t) {
                t = e.extend({}, e.settings.defaults, t), this.each((function () {
            ...
            var n, l, r, s = a.body,
                ...
                y = () => {
                    ...
                    Utils.setLocalItem(o, l), l.dark ? s.setAttribute(g, "dark") : s.removeAttribute(g), e && i.header && e.setAttribute(m, i.header), t && i.sidebar && t.setAttribute(h, i.sidebar), n && i.player && n.setAttribute(v, i.player)
                },
                f = (e, t, a) => {
                ...
                b = () => {
                    ...
                    e(s).on("click", (() => {
                        ...
                        a ? (e("[data-theme-option]").removeClass(r), i.dark = "dark" === a, Utils.changeSkin()) : n ? (e("[data-header-option]").removeClass(r), i.header = n) : l ? (e("[data-sidebar-option]").removeClass(r), i.sidebar = l) : s && (e("[data-player-option]").removeClass(r), i.player = s), t.addClass(r), y()
                    }))
                };
            (r = Utils.getLocalItem(o)) && (i = e.extend({}, i, r)), y(), n = a.createElement("div"), l = `<a href="javascript:void(0);" id="${d}_toggler">Settings</a>\n                    <div class="${d}__wrapper">\n                        <div class="${d}__head">${p}</div>\n                        <div class="${d}__body">`, l += f(c, "Theme", "theme"), l += f(u, "Header", "header"), l += f(u, "Sidebar", "sidebar"), l += f(u, "Player", "player"), l += '<p class="mt-4">Note: You can see the color change effect of the header, sidebar and player in the inner pages.</p></div></div>', n.id = d, n.innerHTML = l, s.appendChild(n), b(), i.dark ? e('[data-theme-option="dark"]').addClass("active") : e('[data-theme-option="light"]').addClass("active"), e("[data-header-option=" + i.header + "]").addClass("active"), e("[data-sidebar-option=" + i.sidebar + "]").addClass("active"), e("[data-player-option=" + i.player + "]").addClass("active")
        }, e.settings.defaults = {
            dark: !1,
            header: null,
            sidebar: null,
