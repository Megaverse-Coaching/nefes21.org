...
var KTCategoryList = function () {
    ...
    var initCategoryTable = function () {
        ...
        $(addForm.querySelector('select[name="admin_id"]')).select2();

        $('input[type=checkbox][name=isConsulting]').change(function () {
            ($(this).is(':checked')) ? $(this).val(1).attr('checked', true) : $(this).val(0).removeAttr('checked');
            ($(this).is(':checked')) ? $("span.isConsulting").html('Evet') : $("span.isConsulting").html('Hayır');
        });

        $('input[type=checkbox][name=status]').change(function () {
            ($(this).is(':checked')) ? $(this).val(1).attr('checked', true) : $(this).val(0).removeAttr('checked');
            ($(this).is(':checked')) ? $("span.isShowing").html('Evet') : $("span.isShowing").html('Hayır');
        });

        $('#floatingInfo').maxlength({
            ...
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        Swal.fire({
                            text: recordName + " kaydı silinemedi.",
                            icon: "error",
                            buttonsStyling: false,
                            confirmButtonText: "Tamam, anladım!",
                            customClass: {
