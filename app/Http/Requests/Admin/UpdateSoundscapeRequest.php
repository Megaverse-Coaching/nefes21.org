...
class UpdateSoundscapeRequest extends FormRequest
{
    /**
    ...
    {
        return $this->user()->can('update soundscape');
    }
    ...
    public function rules()
    {
        return [
            ...
            'imgCover'      => 'image|mimes:jpeg,png,jpg,webp|max:2048|sometimes|dimensions:width=1000,height=1000',
            'imgCover_remove'  => 'sometimes|nullable|boolean',
        ];
    }
